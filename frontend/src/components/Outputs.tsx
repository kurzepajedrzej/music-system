...
export default function Outputs({ topPadding = 'pt-5' }: { topPadding?: string }) {
  ...
  return (
    <aside className={`bg-base-900 ${topPadding} px-5 pb-5 flex flex-col gap-7 overflow-y-auto h-full`}>
